...
from genesis.version4.match_fodo import match_to_FODO
from genesis.version4.constants import *
import numpy as np
...
def run_genesis4(xlamds, sample, dgrid, ngrid, seed,          # Basics
                pulselen, sigma, peak_current, beamprofile = 'F', gam0 = np.around(3990./0.511,3),                   # Define e-beam
                 ...
                 workdir = '/sdf/scratch/users/j/jytang', save_dir = "/sdf/data/ad/ard/u/jytang/test_genesis4/", 
                 nametag = ""):
    ...
    G = Genesis4(input_file = FILE, verbose = True, workdir = workdir, use_temp_dir = True)
